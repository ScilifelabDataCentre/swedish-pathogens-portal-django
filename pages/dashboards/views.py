...
from .visualisation.ww_slu import (
    get_all_sites_plot,
    get_compiled_data,
...
class DashboardSLU(View):
    ...
    def get(self, request):
        ...
        if self.active_page == "Methodology":
            ...
            return render(request, "dashboards/ww_slu/methods.html", context)
        ...
        if self.active_page == "Overview":
            ...
            context["qual_plot_html"] = dashboard_data.get("qual_overview_plot")

            return render(request, "dashboards/ww_slu/overview.html", context)
        ...
        if self.active_page in self.virus_pages:
            ...
            context["qual_plot_html"] = dashboard_data.get(
                f"qual_plot_{slugify(virus)}"
            )

            return render(request, "dashboards/ww_slu/analysis.html", context)
...
class SLUsync(LoginRequiredMixin, View):
    ...
    def get(self, request):
        ...
        return render(request, "dashboards/ww_slu/data_sync.html", context)
