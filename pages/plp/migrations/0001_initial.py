# Generated by Django 6.0.1 on 2026-01-21 15:20
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('plp1', 'PLP1'), ('plp2', 'PLP2'), ('tdp', 'TDP'), ('test', 'PLP-Test'), ('pmt', 'PM TDP')], help_text='Project category (e.g. PLP1, PLP2, TDP)', max_length=20)),
                ...
                ('featured_image', models.ImageField(help_text='Featured image for the project', upload_to='plp/projects/')),
