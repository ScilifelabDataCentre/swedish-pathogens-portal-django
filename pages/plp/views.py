...
# Static timeline data -- cells with HTML links use mark_safe so the
# data_table_content template renders them correctly.


def _link(url: str, label: str) -> str:
    """Build an external link and mark it safe for template rendering."""
    return mark_safe(f'<a href="{url}" target="_blank" rel="noopener noreferrer">{label}</a>')
...
TIMELINE_ROWS: list[list[str]] = [
    [
        ...
        _link(
            ...
            "-development-projects-within-pandemic-laboratory-preparedness"
            "-plp-tdp/",
            "PLPTDP25 Call",
        ),
        (
            "Launch of new TDP funding to drive diagnostics and"
            " host response innovation that will support during"
            " outbreaks."
        ),
    ...
    [
        ...
        "PM TDP Call",
        (
            "Call for clinical tech development in collaboration"
            " with Precision Medicine to address healthcare needs."
        ),
    ...
    [
        "2023-02-01",
        _link(
            "https://anubis.scilifelab.se/call/REPLPCM",
            "REPLPCM Call",
        ),
    ...
    [
        "2022-09-01",
        _link(
            "https://anubis.scilifelab.se/call/REPLP1",
            "REPLP-1 Call",
        ),
    ...
    [
        ...
        "PLP2 Call",
        (
            "To create nationally significant infrastructure"
            " capabilities with a functional expectation within"
            " a year."
        ),
        "Completed",
    ],
    [
        ...
        "TDP Funding Call",
        (
            "The intention with this call was to build closer"
            " connections between clinical microbiology"
            " laboratories in Sweden and to develop capabilities"
            " in major clinical microbiology labs in Sweden."
        ),
        "Completed",
    ],
    [
        ...
        (
            "Focused on BSL3, biobanking, environmental"
            " detection, immunomonitoring, serology, sequencing."
        ),
        "Completed",
    ],
    [
    ...
    [
        ...
        _link(
            ...
            "/2020/12/forskning-frihet-framtid--kunskap-och-innovation"
            "-for-sverige/",
            "Swedish government commissioned SciLifeLab",
        ),
        (
            "The assignment broadly involved supporting research"
            " related to infectious diseases (e.g. in"
            " diagnostics, analysis of infection, immunity, and"
            " the development of resistance to therapies in"
            " pathogens), and developing competence and"
            " technologies related to pandemic research (e.g. in"
            " sequencing, genetic analysis, immunology, and big"
            " data)."
        ),
        "Completed",
    ],
